...
The script updates the Bustago-backed routes (`icn-govcomplex`, `icn2-govcomplex`, `icn-doryong`, `icn2-doryong`, `govcomplex-icn`, `govcomplex-icn2`, `doryong-icn`, `doryong-icn2`, `cjj-yuseong`, `yuseong-cjj`) and writes `first_bus`, `last_bus`, and fare/time data into each file. The route pages pick up the new values automatically on the next Jekyll build.
